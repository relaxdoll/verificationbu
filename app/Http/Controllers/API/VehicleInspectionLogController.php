...
use App\VehicleInspectionLog as Model;


class VehicleInspectionLogController extends BaseController
{

    protected $name = 'VehicleInspectionLog';
    ...
    public function store(Request $request)
    {
        ...
        $input['log'] = json_encode($request->log);
