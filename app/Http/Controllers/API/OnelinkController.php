...
use App\Onelink as Model;


class OnelinkController extends BaseController
{

	protected $name = 'Onelink';
...
//		}
    ...
    {
        return $this->sendResponse($request->toArray(), $this->name . 's received successfully.');
	}
