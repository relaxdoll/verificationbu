@extends('layouts.app', ['activePage' => 'indexReplaceTire', 'titlePage' => __('Liff Starter')])
    ...
    <div class="content">
        <div class="container-fluid">
            <div id="liffAppContent">
                ...
                <div id="statusMessage">
                    ...
                    <div id="apiReferenceMessage">
                        ...
                        <p>Please refer to the <a href="https://developers.line.biz/en/reference/liff/#initialize-liff-app">API reference page</a> for more information.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div id="liffIdErrorMessage" class="hidden">
                ...
                <p>For more information about how to add your LIFF ID, see <a href="https://developers.line.biz/en/reference/liff/#initialize-liff-app">Initializing the
                        LIFF app</a>.</p>
            </div>
            <!-- LIFF INIT ERROR -->
            <div id="liffInitErrorMessage" class="hidden">
                <p>Something went wrong with LIFF initialization.</p>
                <p>LIFF initialization can fail if a user clicks "Cancel" on the "Grant permission" screen, or if an error occurs in the process of
                    <code>liff.init()</code>.
            </div>
...
@push('js')
    ...
    <script src="/js/liff/liff-starter.js"></script>
