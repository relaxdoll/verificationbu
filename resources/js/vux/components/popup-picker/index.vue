<template>
  <div class="" @click.stop="onClick">

      <slot></slot>
      <!--    <div class="" :class="{'weui-cell_access': !disabled}" v-show="showCell">-->
<!--      <div class="weui-cell__hd">-->
<!--        <slot name="title" label-class="weui-label" :label-style="labelStyles" :label-title="title">-->
<!--          <label class="weui-label" :class="labelClass" :style="labelStyles" v-if="title" v-text="title"></label>-->
<!--        </slot>-->
<!--        <inline-desc v-if="inlineDesc">{{ inlineDesc }}</inline-desc>-->
<!--      </div>-->
<!--      <div class="vux-cell-primary vux-popup-picker-select-box">-->
<!--&lt;!&ndash;        <div class="vux-popup-picker-select">&ndash;&gt;-->
<!--&lt;!&ndash;          <span class="" v-if="!displayFormat && !showName && value.length">{{value | array2string}}</span>&ndash;&gt;-->
<!--&lt;!&ndash;          <span class="vux-popup-picker-value vux-cell-value" v-if="!displayFormat && showName && value.length">{{value | value2name(data)}}</span>&ndash;&gt;-->
<!--&lt;!&ndash;          <span class="vux-popup-picker-value vux-cell-value" v-if="displayFormat && value.length">{{ displayFormat(value, value2name(value, data)) }}</span>&ndash;&gt;-->
<!--&lt;!&ndash;          <span v-if="!value.length && placeholder" v-text="placeholder" class="vux-popup-picker-placeholder vux-cell-placeholder"></span>&ndash;&gt;-->
<!--&lt;!&ndash;        </div>&ndash;&gt;-->
<!--      </div>-->
