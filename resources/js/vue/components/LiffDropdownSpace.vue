<template>
    <div style="margin-top: 20px;">
        ...
        <liffdrawerspace @close="selected = false" align="right" :maskclosable="true" :label="label" :currentview="currentview"
                    :closeable="true">
            ...
            <div v-if="selected">
                ...
                <liffgroup style="margin-bottom:60px;">
                    <liffoption @click="select(option)" v-for="(option, index) in setoptions" :key="index" :value="option"
